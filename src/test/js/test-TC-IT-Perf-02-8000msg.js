/**
 * @todo:
 * Monitor the network traffic using tcpdump with perlscript
 * Generate further possible metrics,
 * Update the findings on the confluence
*/
...
// Configure the console.log via the envir
// Tune; SET Debug allow to programmatically setting the debug
// Dynamic generation of batch size of 1 --> Prediction of RBT size handling 
// Reverse Keyword, Bloom Filtering -- Bitfunnel, Bing   
